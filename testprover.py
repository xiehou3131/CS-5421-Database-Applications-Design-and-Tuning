...
class TestStringMethods(unittest.TestCase):
    ...
    def test_axiom2(self):
        ...
        p.we_know_that([["A"], ["B"]])  # step 1
        p.we_know_that([["C"], ["A"]])  # step 2
        p.augmentation([["C"], ["A", "C"]], 2, ["C"])  # step 3
        p.transitivity([["A", "C"], ["A", "B"]], 1, 2)  # step 4
        p.augmentation([["A", "C"], ["A", "B"]], 4, "A")  # step 5
        p.transitivity([["C"], ["A", "B"]], 5, 3)  # step 6
